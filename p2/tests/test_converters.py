...
def test_valid_convertions_from_base_10():
    ...
    assert converter_motor._convert_from_base_10(18, BASE_CHOICES[0]) == "18"
    assert converter_motor._convert_from_base_10(18, BASE_CHOICES[1]) == "10010"
    assert converter_motor._convert_from_base_10(18, BASE_CHOICES[2]) == "22"
    assert converter_motor._convert_from_base_10(18, BASE_CHOICES[3]) == "12"

    assert converter_motor._convert_from_base_10(152, BASE_CHOICES[0]) == "152"
    assert converter_motor._convert_from_base_10(152, BASE_CHOICES[1]) == "10011000"
    assert converter_motor._convert_from_base_10(152, BASE_CHOICES[2]) == "230"
    assert converter_motor._convert_from_base_10(152, BASE_CHOICES[3]) == "98"

    assert converter_motor._convert_from_base_10(1024, BASE_CHOICES[0]) == "1024"
    assert converter_motor._convert_from_base_10(1024, BASE_CHOICES[1]) == "10000000000"
    assert converter_motor._convert_from_base_10(1024, BASE_CHOICES[2]) == "2000"
    assert converter_motor._convert_from_base_10(1024, BASE_CHOICES[3]) == "400"

    assert converter_motor._convert_from_base_10(486485, BASE_CHOICES[0]) == "486485"
    assert converter_motor._convert_from_base_10(486485, BASE_CHOICES[1]) == "1110110110001010101"
    assert converter_motor._convert_from_base_10(486485, BASE_CHOICES[2]) == "1666125"
